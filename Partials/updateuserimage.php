...
move_uploaded_file($tmp_name, "../uploads/$image");
  $sql="update `userdata` set id=$id, photo='$image' where id=$id";
...
a{
  ...
  <div class="container-fluid">
    <a class="navbar-brand" >Update User Picture</a>
...
<div class="card text-center">
  ...
  <div class="mb-3">
            ...
            <td><img src="../uploads/<?php echo $photo?>"  class="rounded-circle" width="100" height="100" > </td>
