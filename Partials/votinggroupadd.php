...
if(isset($_POST['submit'])){
  ...
  $sql="insert into `votes` (username,photo,
    votes) values('$name'
    ,'$image','0')";
...
a{
  ...
  <div class="container-fluid">
    <a class="navbar-brand" >Add Voting Group</a>
...
<div class="card text-center">
  <div class="card-header">
    Adding Voting Group Should Reccomand photo and name
  </div>
  <div class="card-body">
   <form method="POST" enctype="multipart/form-data">
  <div class="mb-3">
                <label class="form-label ">Voter Group Name</label>
                <input type="text" class="form-control" name="username" placeholder="Enter Voter Group Name"
                      />
